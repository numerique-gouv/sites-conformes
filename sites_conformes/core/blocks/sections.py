...
class ResizedTextSection(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/layout_text_block.html"
...
class ImageTextCTASection(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/image_text_cta.html"
...
class ImageAndTextGridSection(BaseSection):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/image_text_grid.html"
...
class CTASection(BaseSection):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/text-cta.html"
...
class SpotlightSection(BaseSection):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/spotlight.html"
...
class AccordionSection(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/sections/accordion_section.html"
