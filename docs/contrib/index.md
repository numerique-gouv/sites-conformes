...
:::{note}
**Cette documentation fait partie du projet, et elle est perfectible.** L'améliorer
— corriger une imprécision, clarifier une étape, ajouter un cas d'usage — est une
contribution à part entière, au même titre que le code. Les sources vivent dans le
dossier `docs/` du dépôt : voir {doc}`guide-contribution`.
:::
